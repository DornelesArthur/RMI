...
public class Node4 implements Serializable {
	...
	public static void main(String[] args){
		try {
			...
			// Info Servidor
			NodeInterface nodeImplementation = new NodeImplementation(4);
			String objName = "rmi://localhost:3004/Node4";
			...
			while(true){
				...
				try{
					...
					Gossip aux = new Gossip(4,1,new Timestamp(System.currentTimeMillis()));
