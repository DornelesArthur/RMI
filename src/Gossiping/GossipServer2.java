...
public class GossipServer2 implements Serializable {
	...
	public static void main(String[] args){
		try {
			...
			// Info Servidor
			NodeInterface nodeImplementation = new NodeImplementation(2);
			String objName = "rmi://localhost:3002/GossipServer2";
			...
			while(true){
				...
				try{
					...
					Gossip aux = new Gossip(2,1,new Timestamp(System.currentTimeMillis()));
